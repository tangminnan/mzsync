package com.menzhenchaxun.owneruser.comment;
...
public enum SMSContent implements SMSTemplate{
	...
	ZHUCE("欢迎您注册「帮邦」，您本次的注册验证码为：#randomCode#。请您妥善保存验证码，勿向他人泄露。","注册"),
	
	
	ZHAOHUI_LOGIN("您正在进行密码找回操作，您本次的验证码为：#randomCode#。请您妥善保存验证码，勿向他人泄露。", "找回登陆密码"),


	LOGIN("欢迎您登录「帮邦」，您本次的验证码为：#randomCode#。请您妥善保存验证码，勿向他人泄露。", "登陆");
