...
function initAudioEvent() {
    ...
    if (audio != null) {
        ...
        audio.oncanplay = function () {
           var times =  document.getElementById('audio-length-total');
           	times.innerText=transTime(audio.duration);
        }
    }
    // // 添加音频自动播放功能
    ...
    audioPlayer.addEventListener('click', function () {
        ...
        if (audio.paused) {
            ...
            var url=$("#mpturl").val();
            window.android.startPlay(JSON.stringify({"id":id,"url":url}));
            audioPlayer.src = 'img/pause.png';
        } else {
            
           /* audio.pause();*/
            window.android.stopPlay();
...
function audioEnded() {
    ...
    document.getElementById('audioPlayer').src = 'img/play.png';
}
